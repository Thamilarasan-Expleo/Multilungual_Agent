...
# payload_result = splitter.build_vectorization_payload(payload_fixture["text"], translate=True)
# logger.info(
...
#     res = splitter.process_document(item["text"], schema_output_path=schema_path, translate=False)
...
# stress_res = splitter.process_document(large_text, schema_output_path=stress_schema_path, translate=False)
# logger.info(
