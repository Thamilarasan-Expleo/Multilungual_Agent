...
print("Initializing Rule-Based Regex Range-Based Evaluation Framework...")
...
ws_dash["B2"] = "Rule-Based Regex Dynamic Sigma Segmentation Dashboard"
...
wb.save("rule_based_regex_test_report.xlsx")
print(f"\n>>> Profile processed successfully at {SIGMA_MULTIPLIER} Standard Deviations!")
print("Spreadsheet updated: 'rule_based_regex_test_report.xlsx'")
